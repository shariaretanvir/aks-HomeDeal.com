...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" OnNextButtonClick="Wizard1_NextButtonClick" BorderStyle="Solid" OnFinishButtonClick="Wizard1_FinishButtonClick" CancelDestinationPageUrl="~/Default.aspx" DisplayCancelButton="True" CancelButtonImageUrl="~/IMG/cancel-sign-button-3053748.jpg" CancelButtonType="Image" FinishCompleteButtonImageUrl="~/IMG/finish-button-png-hi.png" FinishCompleteButtonType="Image" FinishPreviousButtonImageUrl="~/IMG/button-previous.gif" FinishPreviousButtonType="Image" StartNextButtonImageUrl="~/IMG/Next-Button.png" StartNextButtonType="Image" StepNextButtonImageUrl="~/IMG/Next-Button.png" StepNextButtonType="Image" StepPreviousButtonImageUrl="~/IMG/button-previous.gif" StepPreviousButtonType="Image" BackColor="#CCCCFF" Width="800px" SideBarStyle-BorderStyle="Solid" SideBarButtonStyle-BorderStyle="NotSet" SideBarButtonStyle-BackColor="Black">
        <CancelButtonStyle Width="60px" />
        <FinishCompleteButtonStyle Width="70px" />
        <FinishPreviousButtonStyle Width="80px" />
        <HeaderStyle Font-Bold="False" />
        <NavigationButtonStyle Font-Bold="False" BorderStyle="None" />
        <NavigationStyle BackColor="#9966FF" Font-Bold="False" Font-Strikeout="False" />
        <StartNextButtonStyle Width="80px" />
        <StepNextButtonStyle Width="80px" />
        <StepPreviousButtonStyle Width="80px" />
        <SideBarButtonStyle Font-Bold="True" Width="150px" Font-Italic="False" Font-Overline="False" BackColor="#CCCCFF" Font-Underline="True" BorderStyle="None" Font-Size="Larger" Font-Strikeout="False" />
       
        <SideBarStyle VerticalAlign="Top" Font-Bold="True" Wrap="True" Font-Overline="False" BorderStyle="Solid" />
        
        <StepStyle BorderStyle="None" Font-Bold="False" Font-Italic="True" Font-Size="Larger" Font-Strikeout="False" Font-Underline="False" />
        ...
        <WizardSteps>
                ...
                <table class="auto-style1" contenteditable="false" style="border:1px solid black;background-color: bisque;">
                    ...
                    <tr>
                        ...
                        <td class="auto-style33">
                            ...
                            <asp:TextBox ID="TextBoxAdname" CssClass="textbox form-control"   runat="server" Width="200px" Height="30px" ReadOnly="True"></asp:TextBox>
                        </div>
                                </td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style49">
                            <asp:TextBox ID="TextBoxAdemail" ToolTip="Enter Email" CssClass="form-control textbox" Width="200px" Height="30px" runat="server" ></asp:TextBox>
                        </td>
                        <td class="auto-style50">
                            <asp:RegularExpressionValidator ID="RegularExpressionValidatorEmail" runat="server" ControlToValidate="TextBoxAdemail" ErrorMessage="Email Must Be Valid" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic"></asp:RegularExpressionValidator>
                    ...
                    <tr>
                        ...
                        <td class="auto-style46">
                            <asp:TextBox ID="TextBoxAdphon" ToolTip="Enter PhoneNo"  CssClass="form-control textbox" Width="200px" Height="30px" runat="server"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style7">
                            <asp:DropDownList ID="DropDownListLocation" CssClass="form-control" runat="server" Width="200px">
            ...
            <asp:WizardStep ID="WizardStep2" runat="server" Title=" Step 2 - Product Details">
                <table class="auto-style1" style="background-color: bisque;">
                    ...
                    <tr >
                        ...
                        <td class="auto-style28" style="padding-bottom:10px; padding-top:10px">
                            <asp:DropDownList ID="DropDownListcata" runat="server" CssClass="form-control" Width="200px"  Style="margin-left: 0px; padding-bottom:10px;"
                    ...
                    <tr>
                        ...
                        <td class="auto-style30"style="padding-bottom:10px">
                            <asp:DropDownList ID="DropDownListsubcata" runat="server" CssClass="form-control" Width="200px"
                    ...
                    <tr>
                        ...
                        <td class="auto-style30" style="padding-bottom:10px">
                            <asp:TextBox ID="TextBoxAdtitle" placeholder="Enter Product Name" CssClass="textbox form-control" runat="server" Width="200px" Height="30px" Style="margin-left: 0px"></asp:TextBox>
                        </td>
                        <td class="auto-style10">
                    ...
                    <tr>
                        ...
                        <td class="auto-style30" style="height:100px;padding-bottom:10px">
                            <asp:TextBox ID="TextBoxAddescription" placeholder="Enter Description" CssClass="textbox form-control" runat="server" Width="200px" Height="100px" TextMode="MultiLine" Rows="10"></asp:TextBox>
                        </td>
                        <td class="auto-style10">
                    ...
                    <tr>
                        ...
                        <td class="auto-style25">
                            <asp:TextBox ID="TextBoxAdprice" placeholder="Enter Price" CssClass="textbox form-control" runat="server" Width="200px" Height="30px"></asp:TextBox>
                        </td>
            ...
            <asp:WizardStep ID="WizardStep3" runat="server" Title="Step 3 - Summary" ClientIDMode="Inherit">
