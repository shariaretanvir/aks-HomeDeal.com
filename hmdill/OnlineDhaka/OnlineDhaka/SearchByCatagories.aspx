...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1"
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="SearchByCatagoriesDetails.aspx?Id={0}" ControlStyle-CssClass="btn btn-sm btn-info"  Text="See Details" />
