        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            if (temp == 0)
            {
                try
                {
                    ...
                    Label3.Text = "<div class='alert alert-info' role='alert'>Successfully Registered</div>";
                    conn.Close();
                }
                catch (Exception ex)
                {
                    Response.Write("error :" + ex.ToString());
                    Label3.Text = "<div class='alert alert-danger' role='alert'>Cannot Registered</div>";
                }
            }
        }
    }﻿
