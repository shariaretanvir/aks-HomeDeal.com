...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="GridView1"
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="Id" ControlStyle-CssClass="btn btn-sm btn-info"  DataNavigateUrlFormatString="SearchBySubcatagoriesDetails.aspx?Id={0}" Text="See Details" />
