...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p style="font-weight: 700">
        ...
        <asp:Button ID="Button4" runat="server" CssClass="btn btn-sm btn-success"   Text="Most Recent Ads" Width="150px" OnClick="Button4_Click" />
        &nbsp;<asp:Button ID="Button2" runat="server" CssClass="btn btn-sm btn-primary" OnClick="Button2_Click1" Text="Search by  catagories" Width="150px" />
&nbsp;<asp:Button ID="Button3" runat="server" CssClass="btn btn-sm btn-warning" Text="Search By Subcatagories" Width="150px" OnClick="Button3_Click" />
    </p>
<p style="font-weight: 700; padding-top:30px" >
    ...
    <div style="width:97%; overflow:auto;background-color: orange;padding:10px;" >
        ...
        <asp:GridView ID="GridView11"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="Detail.aspx?Id={0}" Text="See Details" ControlStyle-CssClass="btn btn-info btn-sm" />
                <asp:TemplateField HeaderText="Image" SortExpression="Image">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Image ID="Image1" runat="server" Height="82px" CssClass="Image1" ImageUrl='<%# Bind("Image") %>' Width="120px" />
                    </ItemTemplate>
                </asp:TemplateField>
