<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Sports.aspx.cs" Inherits="OnlineDhaka.Sports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:Menu ID="EMenu" runat="server" BackColor="#FFFBD6" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#990000" StaticSubMenuIndent="10px">
            ...
            <Items>
                <asp:MenuItem NavigateUrl="~/Sports.aspx" Text="Sports" Value="Sports">
                    <asp:MenuItem NavigateUrl="~/Boot.aspx" Text="Boot" Value="Boot"></asp:MenuItem>
                    <asp:MenuItem NavigateUrl="~/Bat.aspx" Text="Bat" Value="Bat"></asp:MenuItem>
                    <asp:MenuItem NavigateUrl="~/Ball.aspx" Text="Ball" Value="Ball"></asp:MenuItem>
                    <asp:MenuItem NavigateUrl="~/OtherSports.aspx" Text="Others" Value="Others"></asp:MenuItem>
                </asp:MenuItem>
            </Items>
    ...
    <div style="width: 97%; overflow: auto; background-color: orange; padding: 10px;">
        <asp:GridView ID="GridView1"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="SportsDetails.aspx?Id={0}" Text="See Details" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegistrationConnectionString %>" SelectCommand="SELECT * FROM [PostAd] WHERE ([Catagories] = @Catagories)">
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="Sports" Name="Catagories" QueryStringField="Sports" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
