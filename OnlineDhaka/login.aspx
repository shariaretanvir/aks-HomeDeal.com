    ...
    Login Page<table class="auto-style1">
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="TextBoxUsername" CssClass="textbox" runat="server" Width="158px"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:TextBox ID="TextBoxPassword" CssClass="textbox" runat="server" TextMode="Password" Width="156px"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td class="auto-style9">
                <asp:Button ID="Button_Login" runat="server" OnClick="Button_Login_Click" Style="margin-left: 0px" Text="Login" Width="65px" />
            </td>
            <td>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/register.aspx" Style="font-size: medium">New User Register</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td class="auto-style3">&nbsp;</td>
