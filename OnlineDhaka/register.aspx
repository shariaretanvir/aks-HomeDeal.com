    ...
    <table class="auto-style1" style="margin-left: 30px;">
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="TextBoxname" CssClass="textbox" runat="server" Width="180px"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style10">
                <asp:TextBox ID="TextBoxemail" CssClass="textbox" runat="server" Width="180px"></asp:TextBox>
                <br />
            </td>
        ...
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="TextBoxpass" CssClass="textbox" runat="server" TextMode="Password" Width="180px"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="TextBoxconpass" CssClass="textbox" runat="server" TextMode="Password" Width="180px"></asp:TextBox>
                <br />
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style7">
                ...
                <asp:DropDownList ID="DropDownListcountry" runat="server" Width="187px">
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Submit" Width="57px" />
